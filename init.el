...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (cider yasnippet-bundle yasnippet web-mode tagedit smex rainbow-delimiters projectile paredit magit inf-clojure ido-ubiquitous haskell-mode git-rebase-mode git-commit-mode exec-path-from-shell csharp-mode clojure-mode-extra-font-locking auto-complete))))
